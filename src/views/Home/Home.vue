  ...
  <el-row class="home" :gutter="20">
    <el-col :span="8">
      <el-card shadow="hover">
        <div class="user">
          <img :src="userImg" />
          <div class="userinfo">
            <p class="name">Botao</p>
            <p class="access">超级管理员</p>
          </div>
        </div>
        <div class="login-info">
          <p>上次登录时间：<span>2020-06-19</span></p>
    ...
    <el-col :span="16">
      ...
      <div class="graph">
        ...
        <el-card shadow="hover">
          <echart :chartData="echartData.dish" style="height: 260px" :isAxisChart="false"></echart>
        </el-card>
      </div>
    </el-col>
  </el-row>
  ...
  methods: {
    getTableData() {
      this.$http.get('/home/getData').then(res => {
        ...
        // 视频饼图
        this.echartData.dish.series.push({
